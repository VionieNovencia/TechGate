...
export const Notifications: { [key: string]: NotificationsPropTypes } = {
  '1' : {
    ...
    desc: 'We regret to inform you that your application for the Frontend Developer position at PT Sinar Jaya',
  ...
  '2' : {
    ...
    desc: 'We are pleased to inform you that your application for the Frontend Developer position at PT Sinar',
